...
export const MatchInfoPreview = ({
  ...
  return (
    <div className="border border-redsuperlig/30 md:w-[70%] lg:w-[70%] xl:w-[50%] mx-auto rounded-t-2xl text-redsuperlig text-xs py-2 px-4 flex justify-center gap-4">
